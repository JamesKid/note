 ...
 *
 *  5. (技术注意) 微信项目需要手机端调试的话需要运维映射外网已备案域名到内网环境，如 "action.t9.ipr.zbjwork.com 192.168.142.42  "
 *
 ...
 *
 *	17. (技术注意) 如果压力测试不过，可以查看xhprof.t9.zbjev.com（例子为t9测试环境) 下的xhprof日志，去查看具体哪一步占用资源,正常来说测试环境php需要开启 opcache 扩展,否则压测会占用很高的io和cpu.   (技术)
 *
